...
metrics, with packaged-image qualification proving the scrape contract and that
request or credential identities are absent. Live EKS, external TLS,
independent Git-history proof, backend/reconciliation/scratch metrics, alert
