...
| [Rust Core and Multi-Language Platform](platform/README.md) | Low-level Rust runtime, LTX/control formats, executable SQL/Protobuf contracts, language adapters, deployment procedures and acceptance tests |
