...
| [effects.rs](../../../../crates/crab-cell-runtime/src/effects.rs) | Stable source effect IDs/digests, typed registered claim/validation/lease operations, one-effect native supervision, target inbox dedup/savepoint isolation, actor/LTX publication, authenticated generic peer delivery/Resolve, exact-root recovery and sender/inbox cleanup horizons | Add Workflow/Queue effect adapters and catalog-driven node polling |
...
identities. Add Workflow/Queue effect adapters and catalog-driven node polling.
