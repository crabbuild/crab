...
| `packs/pack-{pack-id}.kinds` | compact object-kind proof, plus sparse external REF_DELTA base IDs when present, ordered by pack offset and bound to the Git pack checksum and object count | Immutable, idempotent create |
