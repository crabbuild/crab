    ...
    fn fixture_bucket() -> Vec<ObjectMeta> {
        ...
        vec![
            ...
            ObjectMeta {
                ...
                e_tag: Some("standard-obj".to_owned()),
                version: None,
            ...
            ObjectMeta {
                ...
                size: 1024 * 1024 * 1024,
                last_modified: now - Duration::from_secs(90 * 86_400),
                e_tag: Some("deep-young".to_owned()),
                version: None,
            ...
            ObjectMeta {
                ...
                e_tag: Some("gcs-archive".to_owned()),
                version: None,
