    ...
    return [
        ...
        TextCheck(
            ...
            contains=(
                ...
                "NFS_READ_PATH_BENCH_RUN_ID ?=",
                "NFS_READ_PATH_BENCH_VERIFY_ARGS ?=",
                "CRAB_NFS_READ_PATH_BENCH_RUN_ID",
                "NFS_READ_PATH_BENCH_VERIFY_ARGS",
        ...
        TextCheck(
            ...
            contains=(
                ...
                "NFS_RELEASE_EVIDENCE_OUTPUT",
                "nfs_read_path_benchmark_baseline_run_id",
                "nfs_read_path_benchmark_verify_args",
                "nfs_read_path_benchmark_compare_args",
                "nfs_smoke_baseline_run_id",
                "nfs_smoke_verify_args",
                "nfs_smoke_compare_args",
                "nfs_threshold_min_benchmark_reports",
                ...
                "source \"$output_file\"",
                "nfs_read_path_benchmark_baseline_run_id=11111",
                "nfs_read_path_benchmark_verify_args=--min-pointer-sequential-lease-ratio 1.05",
                "nfs_read_path_benchmark_compare_args=--max-throughput-regression-pct 12",
        ...
        TextCheck(
            "NFS mount workflow retains native smoke and benchmark evidence",
            ...
            contains=(
                ...
                "nfs_read_path_benchmark_verify_args",
                "nfs_read_path_benchmark_compare_args",
                "inputs.nfs_read_path_benchmark_verify_args",
                "inputs.nfs_read_path_benchmark_compare_args",
                "NFS_READ_PATH_BENCH_VERIFY_ARGS",
                "NFS_THRESHOLD_MIN_BENCHMARK_REPORTS",
                "NFS_THRESHOLD_MIN_SMOKE_SUMMARIES",
                ...
                "NFS_READ_PATH_BENCH_EXPECTED_GIT_COMMIT=${{ github.sha }}",
                "NFS_READ_PATH_BENCH_EXPECTED_RUN_ID=\"${NFS_READ_PATH_BENCH_RUN_ID}\"",
                "Summarize NFS read-path benchmark evidence",
                "scripts/nfs-evidence-summary.py benchmark",
                "GITHUB_STEP_SUMMARY",
                "nfs-read-path-benchmark-${{ github.run_id }}-${{ github.run_attempt }}",
                ...
                "actions: read",
                "NFS_READ_PATH_BENCH_BASELINE_RUN_ID",
                "NFS_SMOKE_BASELINE_RUN_ID",
                "nfs_smoke_verify_args",
                "nfs_smoke_compare_args",
                ...
                "nfs-read-path-bench-comparison.json",
                ...
                "scripts/nfs-evidence-summary.py smoke",
                "Download retained NFS read-path benchmark evidence",
                "Suggest NFS threshold args",
                "scripts/nfs-evidence-summary.py thresholds",
                "--benchmark-dir ../nfs-read-path-benchmark",
                '--min-benchmark-reports "${NFS_THRESHOLD_MIN_BENCHMARK_REPORTS:-1}"',
