...
RUN_ROOT="${CRAB_WORKTREE_ROOT:-$HOME/Workspace/CrabCLI/worktree-cow}/$RUN_ID"
BIN_DIR="${CRAB_WORKTREE_BIN_DIR:-$RUN_ROOT/bin}"
CRAB_BIN="${CRAB_WORKTREE_CRAB_BIN:-$BIN_DIR/crab}"
TARGET_DIR="${CARGO_TARGET_DIR:-$HOME/Workspace/crabbuild-target/crab-worktree-cow-smoke}"
