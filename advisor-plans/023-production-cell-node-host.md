...
- **Implementation status**: provider-neutral host owns serving and offline-maintenance runtime construction, and serializes concurrent shutdown/drain callers; full operator-facility ownership and multi-process public-host qualification remain open
