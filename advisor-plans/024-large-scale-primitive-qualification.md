...
handoff for retained protected evidence. It checks workflow provenance, run
attempt, exact source commit, artifact layout, and symlink absence before the
existing pinned-signer and image/profile-bound matrix verification. Protected
