# Plan 002: Add Git protocol v2 and partial clone to Crab

> **Executor instructions**: Plan 001 must land first. Execute this plan as
...
- **Risk**: HIGH
- **Depends on**: Plan 001; a reviewed, current-main version of the remote Git
...
- **Planned at**: `origin/main` commit `8286b925`, 2026-08-14
...
1. Land Plan 001 and re-run its focused and RustFS proof.
...
test -d /Volumes/Workspace && \
  mkdir -p /Volumes/Workspace/crabbuild-target/crab-002-git-v2-partial && \
  test -w /Volumes/Workspace/crabbuild-target/crab-002-git-v2-partial

cargo fmt --all --check

CARGO_TARGET_DIR=/Volumes/Workspace/crabbuild-target/crab-002-git-v2-partial \
