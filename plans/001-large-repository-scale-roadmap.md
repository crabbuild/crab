...
- Checkpoint 100 exposed a separate maintenance defect. The active inventory
  ...
  collisions in larger lower tiers. `f4b532a0` scans every lower tier and has
...
- `f4b532a0` centralizes eligibility for the visibility shortcut and rejects
...
closure and hidden-tier repack correction at `f4b532a0`):
