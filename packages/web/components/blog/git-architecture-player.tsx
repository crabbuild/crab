...
const stories: Record<StoryName, Story> = {
  overview: {
    ...
    edges: [
      { id: "inspect", path: "M156 213 H212", step: 0, label: "inspect", labelX: 184, labelY: 202 },
      { id: "ordinary", path: "M354 198 C386 198 390 105 418 105", step: 1, label: "ordinary", labelX: 386, labelY: 154 },
      { id: "tracked", path: "M354 228 C386 228 390 327 418 327", step: 2, label: "filter=crab", labelX: 386, labelY: 278 },
      { id: "pack", path: "M574 105 H646", step: 3 },
      { id: "xet", path: "M574 327 H646", step: 3 },
      { id: "publish-git", path: "M792 105 C832 105 832 184 872 195", step: 4 },
      { id: "publish-xet", path: "M792 327 C832 327 832 242 872 231", step: 4 },
    ],
    steps: [
  ...
  add: {
    ...
    nodes: [
      ...
      { id: "stream", x: 400, y: 270, width: 178, height: 98, title: "BLAKE3 + chunking", detail: "bounded stream", kind: "xet", firstStep: 2 },
    ...
    edges: [
      { id: "match", path: "M158 213 H212", step: 0 },
      { id: "normal", path: "M354 196 C386 196 390 99 420 99", step: 1, label: "ordinary", labelX: 386, labelY: 149 },
      { id: "stream", path: "M354 230 C382 230 380 319 400 319", step: 2, label: "tracked", labelX: 382, labelY: 278 },
      { id: "chunks", path: "M578 319 H648", step: 2, label: "chunks", labelX: 613, labelY: 307 },
      { id: "flush", path: "M720 270 V140", step: 3, label: "flush", labelX: 740, labelY: 205 },
      { id: "blob-index", path: "M494 58 V46 H820 C852 46 856 182 882 194", step: 4 },
      { id: "pointer-index", path: "M792 99 C838 99 838 220 882 232", step: 4 },
    ],
    steps: [
  ...
  push: {
    ...
    edges: [
      { id: "discover", path: "M158 213 H198", step: 0 },
      { id: "lock", path: "M270 174 V124", step: 1 },
      { id: "gitpack", path: "M342 195 C364 195 368 106 396 106", step: 2 },
      { id: "xorbs", path: "M342 231 C364 231 368 325 396 325", step: 2 },
      { id: "upload-git", path: "M534 106 C568 106 570 182 602 190", step: 3 },
      { id: "upload-xet", path: "M534 325 C568 325 570 244 602 236", step: 3 },
      { id: "verify", path: "M746 213 H814", step: 4 },
      { id: "commit", path: "M881 252 V326", step: 5, label: "commit", labelX: 902, labelY: 289 },
      { id: "compact", path: "M814 361 H746", step: 6, label: "fold", labelX: 780, labelY: 350 },
    ],
    steps: [
  ...
  failure: {
    ...
    edges: [
      { id: "upload", path: "M164 193 C194 193 198 113 226 113", step: 0 },
      { id: "orphan", path: "M307 156 V274", step: 1, label: "safe orphan", labelX: 335, labelY: 220 },
      { id: "reject", path: "M388 317 C416 317 418 232 446 220", step: 2 },
      { id: "compare", path: "M602 211 H666", step: 3 },
      { id: "publish", path: "M802 194 C836 194 838 111 870 111", step: 4 },
      { id: "repair", path: "M734 252 C770 300 832 317 870 317", step: 4 },
    ],
    steps: [
  ...
  hydrate: {
    ...
    edges: [
      { id: "pointer", path: "M150 213 H202", step: 0 },
      { id: "lookup", path: "M346 196 C362 196 364 105 392 105", step: 1 },
      { id: "plan", path: "M462 146 V284", step: 2 },
      { id: "get", path: "M532 325 C564 325 562 230 590 220", step: 3, label: "range GET", labelX: 561, labelY: 279 },
      { id: "rebuild", path: "M730 196 C758 196 758 105 786 105", step: 4 },
      { id: "verify", path: "M860 146 V284", step: 4 },
      { id: "hydrate", path: "M934 325 C958 325 954 233 982 222", step: 5 },
    ],
    steps: [
