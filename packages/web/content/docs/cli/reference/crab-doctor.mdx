...
corrupt catalogs produce warnings without recovery or deletion. Over-budget
usage warns that pruning only removes eligible payloads. These checks do not
verify every payload or index body.
