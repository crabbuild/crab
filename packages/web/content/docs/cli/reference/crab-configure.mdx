...
meta:
  ...
  goal: "Find the supported syntax and behavior for crab configure."
...
```bash
crab configure s3://team-data/models --aws-profile ml-team
```

Crab stores the selector in `.crab/local.toml` and uses the AWS SDK default
