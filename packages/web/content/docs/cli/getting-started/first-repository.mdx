...
The bucket/container itself must already exist. Crab creates the repository
layout inside it, but it does not create cloud accounts, buckets, IAM roles, or
long-lived credentials. After signing in to the provider, verify the complete
setup with:
