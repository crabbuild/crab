...
meta:
  contentType: How-to
  goal: "Use Importing Existing Buckets in an existing Crab repository and verify the result."
...
For direct imports, Crab can build the target `crab://` URL from a bucket and repository name:
