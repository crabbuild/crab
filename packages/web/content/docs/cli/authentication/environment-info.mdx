...
meta:
  ...
  goal: "Find the supported syntax and behavior for Environment Info."
...
`AWS_PROFILE` selects a shared AWS profile. Crab also supports a machine-local
selector through `crab config set auth.aws_profile <name>` and the other
