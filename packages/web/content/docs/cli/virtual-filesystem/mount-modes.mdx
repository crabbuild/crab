...
meta:
  ...
  goal: "Understand Mount Modes and the system boundaries it defines."
...
- Supports switching a mount between branches.
...
- Less convenient for temporary branch views or one-off browsing.
...
app invokes `crab mount` for a user-selected path.
