...
catalog without mutation, and does not initialize Xet state or repair entries.
A failed family remains visible without hiding independent family counts;
partial reports have a nonzero exit. These are live linked-entry measurements,
not an atomic snapshot, integrity verification, or proof of budget enforcement.
See
