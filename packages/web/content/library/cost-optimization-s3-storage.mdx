...
knowledgeCheck:
  question: "What should you do before moving Crab objects to a cheaper storage class?"
  options:
    - "Archive every old object immediately"
    - "Measure access, retrieval, requests, and transfer, then map each cost to a control"
    - "Move shards and refs to the coldest class first"
  answer: 1
  explanation: "Storage price is only one bill term. Measure the workload first, and keep repository metadata readable."
meta:
  contentType: "How-to"
