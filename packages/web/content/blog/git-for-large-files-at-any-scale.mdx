...
```text
local preparation             durable origin                 visible history

discover → pack → upload → verify closure  ║  expected-old ref transaction
                                            ║
          safe to retry or collect          ║  main moves exactly once
```
