...
<LaunchMotionFigure story="dedup" />
...
<LaunchMotionFigure story="publish" />
...
<LaunchMotionFigure story="hydrate" />
...
<TakeawayBox title="Git LFS, without an LFS server">
  Crab natively supports standard Git LFS pointers and commands. Its local
  transfer agent reads and writes whole-file LFS objects directly to your S3,
  GCS, Azure, or S3-compatible object store—without an LFS server or HTTP
  gateway. LFS paths and chunked Crab paths can coexist in one repository.
</TakeawayBox>
