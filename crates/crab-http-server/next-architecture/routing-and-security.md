...
[Design index](README.md) · Private authenticated transport and issue/comment/label/status/check/settings route cutover implemented.
...
by a product request. The issue/comment/label/status/check/settings handlers now
