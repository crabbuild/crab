...
Start with [the crate README](README.md) for the build and reading path.
This reference retains detailed contracts and historical qualification reports;
reported local results are not a current production-readiness guarantee.
