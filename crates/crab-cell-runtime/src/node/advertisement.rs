...
pub(super) struct RawUnsignedIdentity {
    ...
    pub(super) module_digests: Vec<String>,
    pub(super) peer_versions: Vec<u32>,
    pub(super) failure_domain: RawFailureDomain,
}

#[derive(Deserialize, Serialize)]
#[serde(deny_unknown_fields)]
pub(super) struct RawNodeSigningPayload {
    pub(super) identity: RawUnsignedIdentity,
    pub(super) capacity: RawCapacity,
}

#[derive(Deserialize, Serialize)]
#[serde(deny_unknown_fields)]
pub(super) struct RawFailureDomain {
...
#[derive(Deserialize, Serialize)]
#[serde(deny_unknown_fields)]
pub(super) struct RawNodeTombstoneEnvelope {
    pub(super) tombstone: RawNodeTombstone,
}
...
#[derive(Deserialize, Serialize)]
#[serde(deny_unknown_fields)]
pub(super) struct RawNodeTombstone {
    pub(super) version: u8,
    pub(super) session: String,
    pub(super) node: String,
    pub(super) expires_at_ms: String,
    pub(super) retired_at_ms: String,
    pub(super) claimant: Option<String>,
    pub(super) claim_generation: String,
    pub(super) claim_expires_at_ms: Option<String>,
    pub(super) log: Option<RawNodeLog>,
}
...
#[derive(Deserialize, Serialize)]
#[serde(deny_unknown_fields)]
pub(super) struct RawAdvertisement {
    pub(super) version: u8,
    pub(super) identity: RawIdentity,
    pub(super) lease: RawLease,
    pub(super) log: Option<RawNodeLog>,
    pub(super) capacity: RawCapacity,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(super) placement: Option<RawPlacementCapacity>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(super) placement_version: Option<u32>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(super) placement_signature: Option<String>,
}
...
pub(super) struct RawIdentity {
    #[serde(flatten)]
    pub(super) unsigned: RawUnsignedIdentity,
...
#[derive(Deserialize, Serialize)]
#[serde(deny_unknown_fields)]
pub(super) struct RawLease {
    pub(super) generation: String,
    pub(super) progress: String,
    pub(super) issued_at_ms: String,
    pub(super) expires_at_ms: String,
}

#[derive(Deserialize, Serialize)]
#[serde(deny_unknown_fields)]
pub(super) struct RawCapacity {
    pub(super) free_memory_bytes: String,
    pub(super) free_disk_bytes: String,
    pub(super) follower_free_bytes: String,
    pub(super) follower_retained_bytes: String,
    pub(super) job_credits: u32,
    pub(super) log_protocol: u32,
}
...
#[derive(Deserialize, Serialize)]
#[serde(deny_unknown_fields)]
pub(super) struct RawPlacementCapacity {
    pub(super) memory_capacity_bytes: String,
    pub(super) disk_capacity_bytes: String,
    pub(super) active_cells: u32,
    pub(super) max_active_cells: u32,
    pub(super) running_jobs: u32,
    pub(super) job_capacity: u32,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(super) publication_backlog: Option<u32>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(super) hydration_backlog: Option<u32>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(super) primitive_backlog: Option<u32>,
}

#[derive(Deserialize, Serialize)]
#[serde(deny_unknown_fields)]
pub(super) struct RawNodeLog {
    pub(super) state: RawNodeLogPhase,
    pub(super) epoch: String,
    pub(super) members: Vec<String>,
    pub(super) active: bool,
    pub(super) tiered_through: String,
    pub(super) recovery: Option<RawNodeRecoveryClaim>,
    pub(super) recovery_manifest: Option<String>,
}

#[derive(Deserialize, Serialize)]
#[serde(rename_all = "snake_case")]
pub(super) enum RawNodeLogPhase {
    Open,
    Recovering,
    Sealed,
    Retired,
...
#[derive(Deserialize, Serialize)]
#[serde(deny_unknown_fields)]
pub(super) struct RawNodeRecoveryClaim {
