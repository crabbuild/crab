...
| Sparse hydration | [`Db::hydration` and `hydrate_step`](../../crab-ltx/src/managed.rs) are driven by the actor's bounded hydration tick through the existing SQL worker; cancellation/restart and post-promotion zero-I/O qualification remain. |
