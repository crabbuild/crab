...
pub(crate) const SQL_NAMESPACE: NamespaceId = NamespaceId::from_bytes([1; 16]);
pub(crate) const KV_NAMESPACE: NamespaceId = NamespaceId::from_bytes([2; 16]);
pub(crate) const BLOB_NAMESPACE: NamespaceId = NamespaceId::from_bytes([3; 16]);
pub(crate) const QUEUE_NAMESPACE: NamespaceId = NamespaceId::from_bytes([4; 16]);
pub(crate) const DEAD_LETTER_NAMESPACE: NamespaceId = NamespaceId::from_bytes([5; 16]);
pub(crate) const CRON_NAMESPACE: NamespaceId = NamespaceId::from_bytes([6; 16]);
pub(crate) const WORKFLOW_NAMESPACE: NamespaceId = NamespaceId::from_bytes([7; 16]);
pub(crate) const WORKFLOW_DIGEST: Digest = Digest::from_bytes([8; 32]);

pub(crate) const SQL_MODULE: &str = "reference-sql";
pub(crate) const KV_MODULE: &str = "reference-kv";
pub(crate) const BLOB_MODULE: &str = "reference-blob";
pub(crate) const QUEUE_MODULE: &str = "reference-queue";
pub(crate) const DEAD_LETTER_MODULE: &str = "reference-dead-letter";
pub(crate) const CRON_MODULE: &str = "reference-cron";
pub(crate) const WORKFLOW_MODULE: &str = "reference-workflow";
...
pub(crate) fn migration() -> &'static [crab_cell_runtime::registry::MigrationDescriptor] {
...
pub(crate) struct UnregisteredEffects;
...
pub(crate) struct ReferenceBlob;
...
pub(crate) struct ReferenceDeadLetter;
...
pub(crate) struct ReferenceCron;
...
pub(crate) static REFERENCE_DEFINITION: ReferenceDefinition = ReferenceDefinition;
pub(crate) static REFERENCE_DEFINITIONS: &[&'static dyn WorkflowDefinition] =
    &[&REFERENCE_DEFINITION];
pub(crate) static REFERENCE_ACTIVITY_TYPES: &[&str] = &["reference-activity"];

pub(crate) struct ReferenceActivity;
...
pub(crate) struct ReferenceApplication;
...
pub(crate) fn compiled() -> crab_cell_app::CompiledApplication {
...
pub(crate) fn compile_reference_in_order(reverse: bool) -> crab_cell_app::CompiledApplication {
