...
| `artifacts:` declarations | Preserved and validated as catalog metadata. They keep migration unsafe until the artifact lifecycle and remote reachability gates pass; use `crab artifacts` for the local lifecycle. |
