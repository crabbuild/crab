...
description: "Enable Crab Workflow, define a small pipeline, run it, and share the stage cache."
---
...
If this is an existing repository, run the same `crab config set` command from
