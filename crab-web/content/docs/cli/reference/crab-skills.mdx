...
kimi-code-cli                kiro             kiro-cli          kode
lingma      loaf             mcpjam           minimax-code      mistral-vibe
moxby       mux              neovate          ona               openclaw
opencode    openhands        pi               pochi             promptscript
qoder       qoder-cn         qwen             qwen-code         reasonix
replit      roo              roo-code         rovodev           tabnine-cli
terramind   tinycloud        trae             trae-cn            universal
warp        windsurf         zcode            zed               zencoder
zenflow
```
